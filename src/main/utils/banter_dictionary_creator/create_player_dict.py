    ...
    for team in teams:
        ...
        for player in roster.players:
            try:
                ...
                player_dict[NLPConversionUtil().normalize_text(player.name)] = {"team": team.name,
                ...
                position = get_position(player)
                player_dict[player.name] = {"team": team.name, "position": position}
